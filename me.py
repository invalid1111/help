...
class CricticalSection():
    def __init__(self):
        ...
        #initializing semaphore using Semaphore class in threadin module
    def process_1(self):
        while True:
            ...
            self.sem.release()      #incrementing the value of semaphore hence allowingother thread to enter critical section
